...
export const BottomNavigation: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="sticky bottom-0 inset-x-0 z-40 shrink-0 bg-slate-950/95 backdrop-blur-xl border-t border-slate-800/80 px-4 py-2 sm:py-2.5 shadow-2xl shadow-emerald-950/20"
      ...
      <ClickSpark sparkColor="#10b981" sparkCount={6}>
        <div className="max-w-md mx-auto flex items-center justify-around relative">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              clsx(
                'flex flex-col items-center gap-1 py-1.5 px-3 rounded-xl transition-all duration-200 select-none active:scale-90',
                isActive
          ...
          <div className="relative -top-5 flex flex-col items-center">
            <button
              ...
              aria-label="Add Fuel"
              className="w-14 h-14 rounded-full bg-gradient-to-tr from-emerald-400 via-emerald-500 to-teal-400 text-slate-950 flex items-center justify-center shadow-lg shadow-emerald-500/50 border-4 border-slate-950 active:scale-90 hover:scale-105 transition-all duration-200 cursor-pointer animate-pulse-ring"
            >
